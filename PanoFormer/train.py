...
parser.add_argument("--learning_rate", type=float, default=1e-6, help="learning rate")#默认一开始是1e-4
parser.add_argument("--batch_size", type=int, default=2, help="batch size")
parser.add_argument("--num_epochs", type=int, default=300, help="number of epochs")

# loading and logging settings
parser.add_argument("--load_weights_dir", default="E:\PanoFormer-main\PanoFormer-main\PanoFormer\\tmp\panodepth\models\\model123.pth", type=str, help="folder of model to load")#, default='./tmp_abl_offset/panodepth/models/weights_49'
...
parser.add_argument("--disable_color_augmentation", default=True,action="store_true", help="if set, do not use color augmentation")
