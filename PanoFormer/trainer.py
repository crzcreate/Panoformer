...
class Trainer:
    def __init__(self, settings):
        ...
        train_dataset = Matterport3D('E:/PanoFormer-main/PanoFormer-main/PanoFormer/data/panotodepth/train/','./rgb_depth_train.txt', self.settings.disable_color_augmentation, self.settings.disable_LR_filp_augmentation,
        ...
        val_dataset = Matterport3D('E:/PanoFormer-main/PanoFormer-main/PanoFormer/data/panotodepth/val/','./rgb_depth_val.txt', self.settings.disable_color_augmentation, self.settings.disable_LR_filp_augmentation,
    ...
    def process_batch(self, inputs):
        ...
        # 用bon和cor去测试输出图
        # for i in range(2):
        #     vis_outi = visualize_a_data(equi_inputs[i].cpu(), outputs["bon"][i].cpu(), outputs["cor"][i].cpu())
        #     vis_path = f"E:\PanoFormer-main\PanoFormer-main\PanoFormer\\tmp\panodepth\models\layout{i}.png"
        ...
        #     cv2.imwrite(f'E:\PanoFormer-main\PanoFormer-main\PanoFormer\\tmp\panodepth\models\depth{i}.png',depth )
